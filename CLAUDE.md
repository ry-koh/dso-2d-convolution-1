...
├── tb/
│   ├── *.vhd          # Testbench files — paste into Vivado
│   └── vectors/       # Golden vector text files (loaded by testbench via textio)
├── scripts/
│   └── gen_vectors.py # Python golden-vector generator — run outside Vivado
└── synth/
